...
public class ViewVacantRoom implements Command {

	private static final String LIST = "List";
	private static final String MESSAGE_NO_ROOMS = " There are no available rooms";
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<Room> List = roomService.findVacantRooms();
			if (List.size() == 0) {
