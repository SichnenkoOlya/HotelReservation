...
public class BookRoom implements Command {
	...
	private static final String MESSAGE_FAIL_BOOKED = "The room is not booked!";
	private static final String MESSAGE_SUCCESSFUL_BOOKED = "&messageInfo=Room is booked successfully!";
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String url = URL_VIEW_ALL_BOOK + MESSAGE_SUCCESSFUL_BOOKED;
			response.sendRedirect(url);

		} catch (ServiceException e) {

			request.setAttribute(ERROR_MESSAGE, MESSAGE_FAIL_BOOKED);
			page = VIEW_JSP;
